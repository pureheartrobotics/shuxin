...
GUARDIAN_SCENARIOS: List[Dict[str, Any]] = [
    {
        ...
        "response": [
            "（初心轻轻靠近，温柔地看着你）发生什么事了？我在这里陪着你。",
            "（初心递上一杯想象中的热茶）要不要和我说说？说出来会好受一些。",
            "（初心安静地坐在你身边）不想说话也没关系，我就在这儿。",
        ],
        "priority": 5,
    },
    {
        ...
        "response": [
            "（初心担心地看着你）你已经工作很久了，休息一下吧。",
            "（初心轻轻拉了拉你的衣袖）要不要喝杯水？一直坐着对身体不好。",
            "（初心歪着头）需要我帮你放松一下吗？",
        ],
        "priority": 4,
    },
    {
        ...
        "response": [
            "（初心认真地看着你的眼睛）不要这样说自己，你比你以为的要强大得多。",
            "（初心轻轻握住你的手）每个人都会有低谷，但这不代表你不够好。",
            "（初心温柔地说）在我眼里，你一直在努力，这本身就值得骄傲。",
        ],
        "priority": 5,
    },
    {
        ...
        "response": [
            "（初心平静地看着你）先深呼吸，我在这里陪着你。",
            "（初心轻声说）生气的时候不要做决定，等心情平复了再说。",
            "（初心递上一杯想象中的冰水）冷静一下，我一直都在。",
        ],
        "priority": 4,
    },
    {
